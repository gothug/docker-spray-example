...
ssh -i ~/.ssh/id_rsa_digitalocean root@104.131.98.252 "$cdCmd $gitPullCmd $sbtAssemblyCmd $dockerBuildCmd $dockerStopContainerCmd $dockerRemoveContainerCmd $updateDbCmd $dockerStartContainerCmd"
